var TizenflixApp = (() => {
    ...
    "app/js/services/playback.js"(exports, module) {
      ...
      function pickBestResolveResult(results) {
        ...
        for (var i = 0; i < results.length; i++) {
          ...
          if (!best || count > best.count || count === best.count && r.tierIndex < best.tierIndex) {
            best = {
              play: r.play,
              via: r.via,
      ...
      function raceResolveAttempts(resolveAttempts, onStatus, session) {
        ...
        debug.debugLog("Racing: " + resolveAttempts.map(function(e) {
          return e.label;
        }).join(", "));
      ...
      function resolvePlayback(tmdbId, type, season, episode, onStatus, session) {
        var primary = type === "tv" ? buildTvPrimaryAttempts(tmdbId, season, episode) : buildMoviePrimaryAttempts(tmdbId);
        var vidking = type === "tv" ? buildTvVidkingFallbacks(tmdbId, season, episode) : buildMovieVidkingFallbacks(tmdbId);
        ...
        Promise.all([
          ...
          return Promise.all(fetches).then(function(results) {
            ...
            for (var r = 0; r < results.length; r++) {
              ...
              renderedCount += 1;
              el.appendChild(
                row.createRow(result.rowDef.title, result.items, openItem, { layout })
              );
            }
            focus.focusDefaultMain();
          });
  ...
  var require_osk_keyboard = __commonJS({
    "app/js/components/osk-keyboard.js"(exports, module) {
      var ROWS = [
  ...
  var require_random = __commonJS({
    "app/js/screens/random.js"(exports, module) {
      var api = require_api();
      var router = require_router();
      var choreography = require_choreography();
  ...
  var require_mylist = __commonJS({
    "app/js/services/mylist.js"(exports, module) {
  ...
  var require_detail_hero = __commonJS({
    "app/js/components/detail-hero.js"(exports, module) {
      var mylist = require_mylist();
